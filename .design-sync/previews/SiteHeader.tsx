import { SiteHeader } from '@homedetailing/ui';
...
export function Default() {
  return <SiteHeader logo={<Logo />} links={links} cta={{ href: '#kontakt', label: 'Objednat termín' }} />;
}

export function WithoutCta() {
  return <SiteHeader logo={<Logo />} links={links} />;
}
